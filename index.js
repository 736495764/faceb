...
const UUID = process.env.UUID || 'b7752bf7-68ae-4798-8b21-7f213c30560b'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'xg6ribs28j2k8c2tvp2ga1ss';            // 获取节点的订阅路径
